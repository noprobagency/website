...
const WHATSAPP_HREF =
  'https://wa.me/393204063459?text=Ciao%20Antonio%2C%20ho%20appena%20compilato%20il%20form%20su%20noprob.agency%20e%20volevo%20contattarti%20direttamente.'
    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-start bg-noprob-bg px-6 pt-[120px] pb-[80px]">
        ...
        <h1 className="mb-6 max-w-[700px] text-center font-display font-semibold leading-[1.1em] tracking-[-0.05em] text-np-dark text-[2.2rem] min-[810px]:text-[3rem]">
          ...
          <em className="font-serif font-normal italic">ricevuta.</em>
        </h1>

        <p className="mb-10 max-w-[600px] text-center font-sans text-[17px] font-medium leading-[1.5em] tracking-[-0.02em] text-noprob-text">
          Antonio, il nostro senior eCommerce manager, analizzerà la tua
          richiesta e ti contatterà a breve. Se hai urgenza, scrivigli
        ...
        >
          ...
          <span className="flex flex-col text-left">
            ...
            <span className="flex items-center gap-1.5">
              ...
              <span className="text-[13px] text-[#a9a9a9]">Antonio è online</span>
            </span>
          </span>
        </a>
