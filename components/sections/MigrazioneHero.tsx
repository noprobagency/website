...
const heroPartners = [
  {
    ...
    height: 76,
    className:
      'block h-auto w-full object-contain opacity-[0.85] max-h-[26px] min-[810px]:h-[20px] min-[810px]:w-auto min-[810px]:max-h-none',
  },
  {
    name: 'Google Partner',
    ...
    height: 76,
    className:
      'block h-auto w-full object-contain opacity-[0.85] max-h-[26px] min-[810px]:h-[32px] min-[810px]:w-auto min-[810px]:max-h-none',
  },
  {
    ...
    height: 76,
    className:
      'block h-auto w-full object-contain opacity-[0.85] max-h-[26px] min-[810px]:h-[26px] min-[810px]:w-auto min-[810px]:max-h-none',
  },
  {
    ...
    height: 233,
    className:
      'block h-auto w-full object-contain opacity-[0.85] max-h-[36px] min-[810px]:h-[26px] min-[810px]:w-auto min-[810px]:max-h-none',
  },
] as const

export default function MigrazioneHero({ locale = 'it' }: { locale?: Locale }) {
  ...
  return (
    <section className="flex flex-col items-center overflow-hidden px-5 pt-[65px] pb-[65px] min-[810px]:px-[34px] min-[810px]:pt-[100px] min-[810px]:pb-[60px]">
      ...
      >
        {/* Background icons */}
        <div
          className="pointer-events-none absolute top-[75%] -translate-y-1/2 rotate-[20deg] left-[15px] min-[810px]:left-[300px]"
          style={{ zIndex: 0 }}
        >
          <Image
        ...
        <div
          className="pointer-events-none absolute top-[75%] -translate-y-1/2 -rotate-[15deg] right-[15px] min-[810px]:right-[300px]"
          style={{ zIndex: 0 }}
        >
          <Image
        ...
        <h1 className="max-w-[760px] text-center font-display text-[34px] font-semibold leading-[1.1em] tracking-[-0.07em] text-black min-[810px]:text-[4rem]">
          {d.titlePart1}
        ...
        {/* Micro-benefits */}
        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 py-2 min-[810px]:gap-6">
          {d.microBenefits.map((benefit) => (
        ...
        <div className="flex flex-col items-center gap-[9px] min-[810px]:w-auto min-[810px]:flex-row min-[810px]:flex-nowrap min-[810px]:items-center min-[810px]:gap-2">
          <Link href="#candidatura" data-tracking="migrazione_hero_cta" className="button-principal">
            {d.cta}
          </Link>
        </div>
        ...
        <div className="flex flex-col items-center place-content-center gap-[10px] w-full max-w-[400px]">
          ...
          <div className="grid w-full grid-cols-5 gap-0">
            {heroPartners.map((partner) => (
              <div
                key={partner.name}
                className="place-self-start h-10 w-full overflow-visible flex items-center justify-center px-2"
              >
                <Image
                  src={partner.src}
                  alt={partner.name}
