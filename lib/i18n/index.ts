...
const it: Dictionary = {
  navbar: {
    ...
    navLinks: [
      ...
      { label: 'Casi d\u2019Uso', href: '/it/use-cases' },
      { label: 'Blog', href: '/it/blog' },
      { label: 'Contatti', href: '/it/contacts' },
    ],
    serviceItems: [
    ...
    plans: [
      {
        ...
        secondaryHref: '/it/data-driven-team',
      },
      {
        ...
        ctaHref: '/it/contacts',
        secondary: 'Scopri di pi\u00f9 sul piano',
        secondaryHref: '/it/ecommerce-rebuild',
      },
    ],
    from: 'A partire da',
    trustpilotLabel: 'Scelti da brand di Moda, Integratori e DTC eCommerce',
